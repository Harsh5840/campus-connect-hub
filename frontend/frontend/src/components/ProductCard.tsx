...
export const ProductCard = ({ image, title, price, location, condition }: ProductCardProps) => {
	return (
		<Card className="group cursor-pointer overflow-hidden border border-border hover:shadow-lg transition-all duration-300 focus-within:ring-2 focus-within:ring-ring">
