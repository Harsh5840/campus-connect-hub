		...
		<div className="min-h-screen bg-background">
			...
			<div className="container mx-auto px-4 pt-24 pb-20">
				<div className="max-w-3xl mx-auto">
					<a href="/marketplace?tab=rent" className="inline-flex items-center gap-2 text-sm text-muted-foreground hover:text-foreground mb-8">
					...
					<Card className="p-8">
						<form className="space-y-6">
							...
							<div className="flex gap-4 pt-4">
								...
								<a href="/marketplace?tab=rent" className="flex-1">
